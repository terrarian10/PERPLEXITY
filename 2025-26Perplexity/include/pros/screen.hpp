 ...
 * medium_center, or large_center. (DOES NOT SUPPORT SMALL)
...
void print(pros::text_format_e_t txt_fmt,
           const std::int16_t line,
           const char* text,
           Params... args) {
 ...
 *     pros::screen::print(TEXT_MEDIUM, 1, "Touch Status (Type): %d",
 * status.touch_status); pros::screen::print(TEXT_MEDIUM, 2, "Last X: %d",
 * status.x); pros::screen::print(TEXT_MEDIUM, 3, "Last Y: %d", status.y);
 *     pros::screen::print(TEXT_MEDIUM, 4, "Press Count: %d",
 * status.press_count); pros::screen::print(TEXT_MEDIUM, 5, "Release Count: %d",
 * status.release_count); pros::delay(20);
 *   }
 * }
 * \endcode
 */
