...
class Rotation : public Device {
  ...
  public:
     ...
     * \code
     * void opcontrol() {
     * 	 pros::Rotation rotation_sensor(1); //Creates a Rotation Sensor on port
     * 1 pros::Rotation reversed_rotation_sensor(-2); //Creates a reversed
     * Rotation Sensor on port 2
     * }
     * \endcode
     */
     ...
     * \code
     * void opcontrol() {
     *   std::vector<Rotation> rotation_all = pros::Rotation::get_all_devices();
     * // All rotation sensors that are connected
     * }
     * \endcode
     */
     ...
     * Rotation [port: rotation._port, position: (rotation position), velocity:
     *(rotation velocity), angle: (rotation angle), reversed: (reversed
     *boolean)]
     *
     * \b Example
     * \code
