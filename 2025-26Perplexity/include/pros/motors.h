 ...
 *
 * \note This function will not respect brake modes, and simply sets the voltage
 ...
 * void opcontrol() {
 *   while (true) {
 *     motor_move_velocity(1, controller_get_analog(E_CONTROLLER_MASTER,
 * E_CONTROLLER_ANALOG_LEFT_Y)); printf("Motor Commanded Velocity: %d\n",
 ...
 *   while (true) {
 *     motor_move(1, controller_get_analog(E_CONTROLLER_MASTER,
 * E_CONTROLLER_ANALOG_LEFT_Y)); printf("Motor Current Draw: %d\n",
 ...
 *   while (true) {
 *     motor_move(1, controller_get_analog(E_CONTROLLER_MASTER,
 * E_CONTROLLER_ANALOG_LEFT_Y)); printf("Motor Direction: %d\n",
 ...
 *   while (true) {
 *     motor_move(1, controller_get_analog(E_CONTROLLER_MASTER,
 * E_CONTROLLER_ANALOG_LEFT_Y)); printf("Motor Efficiency: %d\n",
 ...
 *   while (true) {
 *     motor_move(1, controller_get_analog(E_CONTROLLER_MASTER,
 * E_CONTROLLER_ANALOG_LEFT_Y)); printf("Motor Current Limit Hit?: %d\n",
 ...
 *   while (true) {
 *     motor_move(1, controller_get_analog(E_CONTROLLER_MASTER,
 * E_CONTROLLER_ANALOG_LEFT_Y)); printf("Motor Temp Limit: %d\n",
 ...
 *   while (true) {
 *     motor_move(1, controller_get_analog(E_CONTROLLER_MASTER,
 * E_CONTROLLER_ANALOG_LEFT_Y)); printf("Motor Faults: %d\n",
 ...
 *   while (true) {
 *     motor_move(1, controller_get_analog(E_CONTROLLER_MASTER,
 * E_CONTROLLER_ANALOG_LEFT_Y)); printf("Motor Flags: %d\n",
 ...
 *   while (true) {
 *     motor_move(1, controller_get_analog(E_CONTROLLER_MASTER,
 * E_CONTROLLER_ANALOG_LEFT_Y)); printf("Motor Encoder Count: %d\n",
 ...
 *   while (true) {
 *     motor_move(1, controller_get_analog(E_CONTROLLER_MASTER,
 * E_CONTROLLER_ANALOG_LEFT_Y)); printf("Motor Position: %lf\n",
 ...
 *   while (true) {
 *     motor_move(1, controller_get_analog(E_CONTROLLER_MASTER,
 * E_CONTROLLER_ANALOG_LEFT_Y)); printf("Motor Power: %lf\n",
 ...
 *   while (true) {
 *     motor_move(1, controller_get_analog(E_CONTROLLER_MASTER,
 * E_CONTROLLER_ANALOG_LEFT_Y)); printf("Motor Temperature: %lf\n",
 ...
 *   while (true) {
 *     motor_move(1, controller_get_analog(E_CONTROLLER_MASTER,
 * E_CONTROLLER_ANALOG_LEFT_Y)); printf("Motor Torque: %lf\n",
 ...
 *   while (true) {
 *     motor_move(1, controller_get_analog(E_CONTROLLER_MASTER,
 * E_CONTROLLER_ANALOG_LEFT_Y)); printf("Motor Voltage: %lf\n",
...
typedef struct motor_pid_full_s {
    ...
    /// The integral limit
    uint16_t limit;
    /// The threshold for determining if a position movement hasreached its goa
    /// l. This has no effect for velocity PID calculations.
    uint8_t threshold;
 ...
 * void autonomous() {
 *   motor_move_absolute(1, 100, 100); // Moves 100 units forward
 *   while (!((motor_get_position(1) - 100 < 105) && (motor_get_position(1) -
 * 100 > 95))) {
 *     // Continue running this loop as long as the motor is not within +-5
 * units of its goal delay(2);
 *   }
