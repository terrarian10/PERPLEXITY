...
struct ProfilePoint {
     ...
     *
     * @param ivector The pose and associated dynamics at this state in the
     * path.
     * @param iwheel_velocities The component of the robot's velocity provided
     * by each wheel in meters per second.
    ...
    bool operator==(const ProfilePoint& other) const {
        ...
        return vector == other.vector &&
               nearly_equal(curvature, other.curvature) &&
