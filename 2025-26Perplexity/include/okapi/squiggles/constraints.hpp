...
struct Constraints {
     ...
     *
     * @param imax_vel The maximum allowable velocity for the robot in meters
     * per second.
     ...
     *                       per second. This is not set to the numeric limits
     * by default as that will allow for wild paths.
