...
std::string getShortUnitName(QType q) {
    ...
    try {
        ...
        throw std::domain_error(
            "You have requested the shortname of an unknown unit somewhere "
            "(likely odometry strings). "
            "Shortname for provided unit is unspecified. You can override this "
