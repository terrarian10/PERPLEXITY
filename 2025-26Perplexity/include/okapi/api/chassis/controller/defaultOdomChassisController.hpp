...
class DefaultOdomChassisController : public OdomChassisController {
  public:
    /**
     * Odometry based chassis controller that moves using a separately
     * constructed chassis controller. Spins up a task at the default priority
     * plus 1 for odometry when constructed.
     *
    ...
    DefaultOdomChassisController& operator=(
        const DefaultOdomChassisController& other) = delete;
    DefaultOdomChassisController& operator=(
        DefaultOdomChassisController&& other) = delete;
     ...
     * towards the robot. The robot will stop this far away from the target
     * point.
     */
