...
class OdomChassisController : public ChassisController {
  public:
    /**
     * Odometry based chassis controller. Starts task at the default for
     * odometry when constructed, which calls `Odometry::step` every `10ms`. The
     * default StateMode is `StateMode::FRAME_TRANSFORMATION`.
     *
    ...
    OdomChassisController& operator=(const OdomChassisController& other) =
        delete;
