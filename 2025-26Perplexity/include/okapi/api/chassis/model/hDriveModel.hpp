...
class HDriveModel : public ChassisModel {
  public:
     ...
     * side motors are powered +100%, the robot should move forward in a
     * straight line. When the middle motor is powered +100%, the robot should
     * strafe right in a straight line.
     *
    ...
    /**
     * Drive the robot in an arc. Uses voltage mode. Sets the middle motor to
     * zero velocity.
     *
     * The algorithm is (approximately):
     ...
     * forward speed is 0. Uses voltage mode. Sets the middle motor to zero
     * velocity.
     *
     * @param iforwardSpeed speed in the forward direction
     ...
     * @param ithreshold deadband on joystick values
     */
    virtual void hArcade(double irightSpeed,
     ...
     * @param ithreshold deadband on joystick values
     */
    virtual void hCurvature(double irightSpeed,
                            double iforwardSpeed,
                            double icurvature,
                            double ithreshold = 0);
