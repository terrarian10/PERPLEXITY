...
class AbstractTimer {
  public:
    ...
    /**
     * Returns the time passed in ms since the previous call of getDt(). Does
     * not change the time recorded by getDt().
     *
    ...
    /**
     * Returns the time since the time marker. Returns 0_ms if there is no
     * marker.
     *
