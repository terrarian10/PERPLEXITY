...
class SettledUtil {
  public:
    /**
     * A utility class to determine if a control loop has settled based on
     * error. A control loop is settled if the error is within `iatTargetError`
     * and `iatTargetDerivative` for `iatTargetTime`.
     *
