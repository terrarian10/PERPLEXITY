...
class ChassisControllerBuilder {
  public:
     ...
     */
    ChassisControllerBuilder& withMotors(const Motor& ileft,
                                         const Motor& iright);
    ...
    /**
     * Sets the sensors. The default sensors are the motor's integrated
     * encoders.
     *
     ...
     * Odometry variant.
     *
     * @param imode The new default StateMode used to interpret target points
     * and query the Odometry state.
     ...
     * settled.
     * @param iatTargetTime The minimum time within atTargetError to be
     * considered settled.
     * @return An ongoing builder.
     */
    ...
    /**
     * Sets the TimeUtilFactory used when building an Odometry. The default is
     ...
     * @return An ongoing builder.
     */
    ChassisControllerBuilder& withLogger(
    ...
    /**
     * Builds the ChassisController. Throws a std::runtime_exception if no
     * motors were set or if no dimensions were set.
     *
