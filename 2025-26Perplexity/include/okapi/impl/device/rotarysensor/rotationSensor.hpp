...
class RotationSensor : public ContinuousRotarySensor {
  public:
     ...
     * @param ireversed Whether the sensor is reversed. This will set the
     * reversed state in the kernel.
     */
     ...
     *
     * @return The current rotation in degrees or ``PROS_ERR_F`` if the
