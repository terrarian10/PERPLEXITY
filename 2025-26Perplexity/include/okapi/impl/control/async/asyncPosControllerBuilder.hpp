...
class AsyncPosControllerBuilder {
  public:
     ...
     * @return An ongoing builder.
     */
    AsyncPosControllerBuilder& withMotor(
     ...
     * @return An ongoing builder.
     */
    AsyncPosControllerBuilder& withSensor(
     ...
     * @return An ongoing builder.
     */
    AsyncPosControllerBuilder& withGains(
        const IterativePosPIDController::Gains& igains);
     ...
     * @return An ongoing builder.
     */
    AsyncPosControllerBuilder& withDerivativeFilter(
     ...
     * @return An ongoing builder.
     */
    AsyncPosControllerBuilder& withGearset(
     ...
     * @return An ongoing builder.
     */
    AsyncPosControllerBuilder& withTimeUtilFactory(
     ...
     * @return An ongoing builder.
     */
    AsyncPosControllerBuilder& withLogger(
